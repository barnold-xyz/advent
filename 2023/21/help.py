...
zxcv('2023/21/input.txt', 2)
print("part 1:", zxcv('2023/21/input.txt', 64))

# polynomial extrapolation
a0 = zxcv('2023/21/input.txt', 65)
a1 = zxcv('2023/21/input.txt', 65 + 131)
a2 = zxcv('2023/21/input.txt', 65 + 2 * 131)
